    ...
    func setupLogInButton(){
        ...
        let attributedText = NSMutableAttributedString(string: "Already have an account? ",
                                                       attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 18),
                                                                    NSAttributedString.Key.foregroundColor: UIColor(white: 100, alpha:0.9)])
...
//        signInFacebookButton.backgroundColor = UIColor(red: 58/255, green: 85/255, blue: 159/255, alpha: 1)
        ...
        signInFacebookButton.imageEdgeInsets = UIEdgeInsets(top: 11, left: -225, bottom: 14, right: 0)
        signInFacebookButton.titleEdgeInsets = UIEdgeInsets(top:0, left:-500.0, bottom:0.0, right:0.0)
        
        signInFacebookButton.backgroundColor = UIColor(red: 255/255.0, green: 255/255.0, blue: 255/255.0, alpha:0.8)
        signInFacebookButton.setTitleColor(UIColor.black, for: .normal)
...
//        signInGoogleButton.tintColor = .white
        ...
        signInGoogleButton.imageEdgeInsets = UIEdgeInsets(top: 13, left: -225, bottom: 14, right: -2)
        signInGoogleButton.titleEdgeInsets = UIEdgeInsets(top:0, left:-490.0, bottom:0.0, right:0.0)
        
        signInGoogleButton.backgroundColor = UIColor(red: 255/255.0, green: 255/255.0, blue: 255/255.0, alpha:0.8)
        signInGoogleButton.setTitleColor(UIColor.black, for: .normal)
    }
...
//        createAccountButton.backgroundColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.5)
        ...
        createAccountButton.imageEdgeInsets = UIEdgeInsets(top: 12, left: -225, bottom: 13, right: -3)       // 200
        createAccountButton.titleEdgeInsets = UIEdgeInsets(top:0, left:-500.0, bottom:0.0, right:0.0)       // 450
        
        createAccountButton.backgroundColor = UIColor(red: 255/255.0, green: 255/255.0, blue: 255/255.0, alpha:0.8)
